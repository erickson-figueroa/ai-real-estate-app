    ...
    <div className="ChatInterface">
      <nav className="navbar navbar-expand-lg bg-body-tertiary fixed-top p-3">
        <div className="container-fluid">
          <a className="navbar-brand fw-semibold" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-buildings" viewBox="0 0 16 16">
  ...
  <path d="M2 11h1v1H2zm2 0h1v1H4zm-2 2h1v1H2zm2 0h1v1H4zm4-4h1v1H8zm2 0h1v1h-1zm-2 2h1v1H8zm2 0h1v1h-1zm2-2h1v1h-1zm0 2h1v1h-1zM8 7h1v1H8zm2 0h1v1h-1zm2 0h1v1h-1zM8 5h1v1H8zm2 0h1v1h-1zm2 0h1v1h-1zm0-2h1v1h-1z"/>
          ...
          <div className="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
            <ul className="navbar-nav">
              ...
              <li className="nav-item dropdown">
                ...
                <span class="badge custom-text-bg-primary mx-3 px-3 p-2"> Your Account </span>
                </a>
      ...
      {!showResults && (
        <>
          ...
          <div className="input-group mb-3 input-container mt-1">
            <input
              type="text"
